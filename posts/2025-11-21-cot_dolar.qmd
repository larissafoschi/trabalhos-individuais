...
Alguns dias, como finais de semana e feriados, não possuem valores retornados pela API. Para manter a continuidade da linha do gráfico, utiliza-se o valor do último dia útil anterior:
